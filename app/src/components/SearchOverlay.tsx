...
export function SearchOverlay({
  ...
  const commands = useMemo<Command[]>(
    () => [
      ...
      { id: 'spaces', label: 'Go to Spaces', icon: <Layers size={15} />, keywords: 'canvas board', run: go({ kind: 'spaces' }) },
      { id: 'newspace', label: 'New space', icon: <Layers size={15} />, keywords: 'canvas board create', run: act(actions.newSpace) },
